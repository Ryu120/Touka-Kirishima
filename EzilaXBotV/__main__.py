...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text(
            "I'm alive, want some coffee? [🧚‍♀️](https://telegra.ph/file/2e799b4fe1b90a2f619a0.mp4) !\n<b>I am awake since:</b> <code>{}</code>".format(
                uptime
            ),
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@Toukakirishimasupport", "[I AM NOW ALIVE❤](https://telegra.ph/file/2e799b4fe1b90a2f619a0.mp4) ")
        except Unauthorized:
            LOGGER.warning(
